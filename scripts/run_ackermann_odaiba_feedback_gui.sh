...
CARLA_COSIM_ACKERMANN_FEEDBACK_ACTORS=${CARLA_COSIM_ACKERMANN_FEEDBACK_ACTORS:-AV,*}
TERASIM_COSIM_EXTERNAL_STATE_ROUTE_LOOKAHEAD_ONLY=${TERASIM_COSIM_EXTERNAL_STATE_ROUTE_LOOKAHEAD_ONLY:-1}
CARLA_COSIM_ACKERMANN_CONTROL_LOG_RECORDS=${CARLA_COSIM_ACKERMANN_CONTROL_LOG_RECORDS:-0}
CARLA_COSIM_ACKERMANN_CONTROL_LOG_ACTORS=${CARLA_COSIM_ACKERMANN_CONTROL_LOG_ACTORS:-}
CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_ENABLED=${CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_ENABLED:-1}
CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_ENGAGE_DECEL=${CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_ENGAGE_DECEL:-4.0}
CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_RELEASE_DECEL=${CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_RELEASE_DECEL:-1.0}
CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_RELEASE_TICKS=${CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_RELEASE_TICKS:-3}
CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_STOP_SPEED=${CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_STOP_SPEED:-0.2}
CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_MIN_BRAKE=${CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_MIN_BRAKE:-0.5}
...
COSIM_EXPECTED_STEP_LENGTH=${COSIM_EXPECTED_STEP_LENGTH:-${CARLA_COSIM_STEP_LENGTH}}
...
echo "Using external-state route lookahead only: ${TERASIM_COSIM_EXTERNAL_STATE_ROUTE_LOOKAHEAD_ONLY}"
echo "Using direct emergency brake: enabled=${CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_ENABLED} engage=-${CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_ENGAGE_DECEL}m/s^2 release=-${CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_RELEASE_DECEL}m/s^2 releaseTicks=${CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_RELEASE_TICKS} stopSpeed=${CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_STOP_SPEED}m/s minBrake=${CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_MIN_BRAKE}"
echo "Using Ackermann control trace: enabled=${CARLA_COSIM_ACKERMANN_CONTROL_LOG_RECORDS} actors=${CARLA_COSIM_ACKERMANN_CONTROL_LOG_ACTORS:-all}"
...
export TERASIM_COSIM_EXTERNAL_STATE_ROUTE_LOOKAHEAD_ONLY
export CARLA_COSIM_ACKERMANN_CONTROL_LOG_RECORDS
export CARLA_COSIM_ACKERMANN_CONTROL_LOG_ACTORS
export CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_ENABLED
export CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_ENGAGE_DECEL
export CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_RELEASE_DECEL
export CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_RELEASE_TICKS
export CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_STOP_SPEED
export CARLA_COSIM_ACKERMANN_EMERGENCY_BRAKE_MIN_BRAKE
...
export CARLA_COSIM_STEP_LENGTH
export COSIM_EXPECTED_STEP_LENGTH
